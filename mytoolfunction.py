...
def ChooseLoadNpArray(filepath, file, Choose_method):
    ...
    if file == 'total_train':
        ...
        if (Choose_method == 'normal'):
            ...
            # x_train = np.load(filepath + "x_train_CIC_ToN-IoT_20231220.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_CIC_ToN-IoT_20231220.npy", allow_pickle=True)
        ...
        if (Choose_method == 'normal'):
            ...
            # # 20231204 after SMOTE Label8,Label9, Label13到原本的兩倍
            ...
            # # 20231220 after do labelencode and minmax
            x_train = np.load(filepath + "x_train_half1_ToN-IoT_20231220.npy", allow_pickle=True)
            y_train = np.load(filepath + "y_train_half1_ToN-IoT_20231220.npy", allow_pickle=True)

            # # # 20231220 after PCA do labelencode and minmax
            # x_train = np.load(filepath + "x_train_half1_ToN-IoT_afterPCA_20231220.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half1_ToN-IoT_afterPCA_20231220.npy", allow_pickle=True)
        elif (Choose_method == 'SMOTE'):
            # # 20231225 SMOTE  Label 3 after SMOTE 4500
            # x_train = np.load(filepath + "x_train_half1_SMOTE_Label1_and_Label3_Label6_20231225.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half1_SMOTE_Label1_and_Label3_Label6_20231225.npy", allow_pickle=True)

            # # # 20231225 borderLineSMOTE1 Label 3 after SMOTE 4500 k=5  M = 10 
            # x_train = np.load(filepath + "x_train_half1_BorederlineSMOTE_borderline-1_Label1_and_Label3_Label6_20231225.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half1_BorederlineSMOTE_borderline-1_Label1_and_Label3_Label6_20231225.npy", allow_pickle=True)

            # # # 20231225 borderLineSMOTE2 Label 3 after SMOTE 4500 k=5  M = 10 
            # x_train = np.load(filepath + "x_train_half1_BorederlineSMOTE_borderline-2_Label1_and_Label3_Label6_20231225.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half1_BorederlineSMOTE_borderline-2_Label1_and_Label3_Label6_20231225.npy", allow_pickle=True)

            # # 20231226 SMOTE  Lable1  Label 3 Label 4 Label6 Label9 k=5 after SMOTE
            # x_train = np.load(filepath + "x_train_half1_SMOTE_Label1_and_Label3_Label4_Label6_Label9_20231226.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half1_SMOTE_Label1_and_Label3_Label4_Label6_Label9_20231226.npy", allow_pickle=True)

            # # # 20231226 borderLineSMOTE1 Lable1  Label 3 Label 4 Label6 Label9 k=5  M = 10 
            # x_train = np.load(filepath + "x_train_half1_BorederlineSMOTE_borderline-1_Label1_and_Label3_Label4_Label6_Label9_20231226.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half1_BorederlineSMOTE_borderline-1_Label1_and_Label3_Label4_Label6_Label9_20231226.npy", allow_pickle=True)
            ...
            y_train = np.load(filepath + "y_train_half1_BorederlineSMOTE_borderline-2_Label1_and_Label3_Label4_Label6_Label9_20231226.npy", allow_pickle=True)
        ...
        if (Choose_method == 'normal'):
            ...
            # 20231220 after do labelencode and minmax
            x_train = np.load(filepath + "x_train_half2_ToN-IoT_20231220.npy", allow_pickle=True)
            y_train = np.load(filepath + "y_train_half2_ToN-IoT_20231220.npy", allow_pickle=True)

            # # 20231220 after PCA do labelencode and minmax
            # x_train = np.load(filepath + "x_train_half2_ToN-IoT_afterPCA_20231220.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half2_ToN-IoT_afterPCA_20231220.npy", allow_pickle=True)
        elif (Choose_method == 'SMOTE'):

            # # 20231225 SMOTE  Lable1 k=5 and Label 3 k=5 Label 4 Label13 k=5 after SMOTE 4500
            # x_train = np.load(filepath + "x_train_half2_SMOTE_Label1_and_Label3_Label4_20231225.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half2_SMOTE_Label1_and_Label3_Label4_20231225.npy", allow_pickle=True)

            # # # 20231225 borderLineSMOTE1 Lable1 k=5 and Label 3 k=5 Label 4 Label13 k=5 after SMOTE 4500 k=5  M = 10 
            # x_train = np.load(filepath + "x_train_half2_BorederlineSMOTE_borderline-1_Label1_and_Label3_Label4_20231225.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half2_BorederlineSMOTE_borderline-1_Label1_and_Label3_Label4_20231225.npy", allow_pickle=True)

            # # # 20231225 borderLineSMOTE2 Lable1 k=5 and Label 3 k=5 Label 4 Label13 k=5 after SMOTE 4500 k=5  M = 10 
            # x_train = np.load(filepath + "x_train_half2_BorederlineSMOTE_borderline-2_Label1_and_Label3_Label4_20231225.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half2_BorederlineSMOTE_borderline-2_Label1_and_Label3_Label4_20231225.npy", allow_pickle=True)

            # # 20231226 SMOTE  Lable1  Label 3 Label 4 Label6 Label9 k=5 after SMOTE
            # x_train = np.load(filepath + "x_train_half2_SMOTE_Label1_and_Label3_Label4_Label6_Label9_20231226.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half2_SMOTE_Label1_and_Label3_Label4_Label6_Label9_20231226.npy", allow_pickle=True)
            
            # # # 20231226 borderLineSMOTE1 Lable1  Label 3 Label 4 Label6 Label9 k=5  M = 10 
            # x_train = np.load(filepath + "x_train_half2_BorederlineSMOTE_borderline-1_Label1_and_Label3_Label4_Label6_Label9_20231226.npy", allow_pickle=True)
            # y_train = np.load(filepath + "y_train_half2_BorederlineSMOTE_borderline-1_Label1_and_Label3_Label4_Label6_Label9_20231226.npy", allow_pickle=True)
...
def RealpaceSymboltoTheMostCommonValue(dataset):
    ...
    for column in dataset.columns:
        ...
        # 将每列中的空白值替换为最常见值
        dataset[column]=dataset[column].fillna(most_common_value)
...
def ReplaceMorethanTenthousandQuantity(df,Label_column_name):
    ...
    for label in unique_labels:
        # 选择特定标签的行
        label_df = df[df[Label_column_name] == label]
    ...
    # 打印修改后的结果
    print(extracted_df[Label_column_name].value_counts())
    return extracted_df
